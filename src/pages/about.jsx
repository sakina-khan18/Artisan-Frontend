...
const AboutUs = () => {
  ...
  const craftDetails = [
    { state: 'Assam', description: 'Famous for silk weaving (Muga, Eri, Pat), bell metal crafts, and cane & bamboo products', image: '/api/placeholder/400/300' },
    { state: 'Meghalaya', description: 'Known for bamboo and cane crafts, traditional textiles, and indigenous jewelry making', image: '/api/placeholder/400/300' },
    { state: 'Nagaland', description: 'Renowned for wood carving, tribal textiles with geometric patterns, and metalwork', image: '/api/placeholder/400/300' },
    { state: 'Manipur', description: 'Celebrated for handloom textiles, Longpi pottery, and intricate bamboo crafts', image: '/api/placeholder/400/300' },
    { state: 'Tripura', description: 'Recognized for bamboo handicrafts, handloom textiles, and Risha (traditional stoles)', image: '/api/placeholder/400/300' },
    { state: 'Arunachal Pradesh', description: 'Distinguished by its tribal weaving, carpet making, and wood carving traditions', image: '/api/placeholder/400/300' }
  ];
...
<div className="relative bg-gradient-to-r from-slate-900 to-slate-800 text-white">
  <div className="absolute inset-0 opacity-30 bg-cover bg-center" style={{ backgroundImage: "url('/api/placeholder/1600/600')" }}></div>
  <div className="relative container mx-auto px-4 py-28 md:py-36 flex flex-col items-center">
    ...
    <div className="mt-10 flex flex-wrap gap-4 justify-center">
      <Link to="/shop" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-transform hover:scale-105">
        Our Collection
      </Link>
      <Link  to="/artisans" className="bg-transparent border-2 border-white hover:bg-white hover:text-slate-800 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all">
        Meet Our Artisans
      </Link>
    </div>
  </div>
  ...
  <div className="absolute -bottom-2 left-0 right-0">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 40" className="w-full h-auto">
      <path fill="#fff9e6" fillOpacity="1" d="M0,32L80,26.7C160,21,320,11,480,16C640,21,800,43,960,42.7C1120,43,1280,21,1360,10.7L1440,0L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
    </svg>
  </div>
</div>
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24 items-center">
          <div>
            ...
            Our story began with a vision to showcase the vibrant and diverse handicrafts of North Eastern India to the world. Inspired by the rich heritage and the incredible craftsmanship of local artisans, we set out to create a platform that not only honors their skills but also provides them with the recognition they deserve.
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
            Every product on our platform tells a story—of tradition passed down through generations, of creativity rooted in culture, and of artisans who pour their hearts into every piece. We are passionate about preserving these traditions while empowering artisans with opportunities to thrive in the modern market.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
           
              Today, ArtisanKart stands as a bridge between tradition and modernity, helping artisans 
              reach global markets while preserving their cultural identity and traditional methods.
            </p>
          </div>
        ...
        <div className="bg-orange-100 rounded-xl p-10 mb-24 shadow-lg">
          <h3 className="text-3xl font-semibold text-orange-800 mb-8 text-center">Our Impact</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg p-6 text-center shadow-md transition-transform hover:scale-105">
              <div className="w-16 h-16 bg-orange-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">500+</div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-md transition-transform hover:scale-105">
              <div className="w-16 h-16 bg-orange-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">25+</div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-md transition-transform hover:scale-105">
              <div className="w-16 h-16 bg-orange-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">8</div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-md transition-transform hover:scale-105">
              <div className="w-16 h-16 bg-orange-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">100%</div>
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-slate-800 mb-4">North Eastern Craft Heritage</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {craftDetails.map((craft, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-[1.02]">
                <div className="relative h-48">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                    <h3 className="text-white text-2xl font-semibold p-4">{craft.state}</h3>
                  </div>
                </div>
                <div className="p-4">
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-slate-800 mb-4">Meet Our Team</h2>
            <div className="w-24 h-1 bg-orange-500 mx-auto mb-6"></div>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map(member => (
              <div key={member.id} className="bg-white rounded-lg shadow-xl overflow-hidden group">
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-slate-800 mb-4">Our Values</h2>
            <div className="w-24 h-1 bg-orange-500 mx-auto mb-6"></div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-orange-600 mb-4">Authenticity</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-orange-600 mb-4">Sustainability</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-orange-600 mb-4">Community</h3>
              <p className="text-gray-700">
        ...
        <div className="relative mb-12 overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: "url('/api/placeholder/1600/600')" }}></div>
          <div className="relative bg-gradient-to-r from-orange-600 to-orange-400 text-white rounded-xl p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
             ...
             <Link to="/shop" className="bg-white text-orange-600 font-bold py-4 px-8 rounded-full hover:bg-orange-50 shadow-lg transition-transform hover:scale-105">
                Shop Collection
              </Link>
             
              <Link  to="/artisans" className="border-2 border-white text-white font-bold py-4 px-8 rounded-full hover:bg-orange-500 transition-transform hover:scale-105">
                Meet Our Artisans
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 mb-20">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Stay Connected</h3>
              <p className="text-gray-700 mb-4">
                Join our community of craft enthusiasts and be the first to know about new artisans, collections, 
                and stories from North Eastern India.
              </p>
